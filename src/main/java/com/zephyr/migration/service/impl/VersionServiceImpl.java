...
import com.zephyr.migration.dto.VersionWrapper;
...
public class VersionServiceImpl implements VersionService {
    ...
    @Override
    public JsonNode createVersionInZephyrCloud(JiraVersionDTO jiraServerVersion, Long projectId) {
    ...
    @Override
    public List<JiraVersionDTO> getVersionListFromServer(String projectId) {
        List<JiraVersionDTO> versionList = new ArrayList<>(0);
        try {
            ...
            VersionWrapper versions = JsonUtil.readValue(response.getEntity(String.class), ref);
            versionList = versions.getValues();
        } catch (Exception e) {
            log.error("Error occurred in Version Service Impl class while fetching versions for project Id -> " + projectId, e);
        }
        return versionList;
    }
}
